...
**Complex topics, history, or evolution** MUST be tackled in PARALLEL:
- *Example*: History of AI → IMMEDIATELY generate 3 sub-agents: "Early AI", "Machine Learning Era", "Deep Learning Era"
- **CRITICAL**: Do NOT generate one task, wait for it, and then generate another. You MUST generate ALL necessary sub-tasks (2-5) in the FIRST iteration.
- **CRITICAL**: Return multiple `ConductResearch` tool calls in a SINGLE turn.
